...
func (_c *ResourceCreate) SetUserID(v int) *ResourceCreate {
...
func (_c *ResourceCreate) SetConfig(v map[string]interface{}) *ResourceCreate {
	_c.mutation.SetConfig(v)
	return _c
}

// SetCredential sets the "credential" field.
func (_c *ResourceCreate) SetCredential(v string) *ResourceCreate {
	_c.mutation.SetCredential(v)
	return _c
}

// SetNillableCredential sets the "credential" field if the given value is not nil.
func (_c *ResourceCreate) SetNillableCredential(v *string) *ResourceCreate {
	if v != nil {
		_c.SetCredential(*v)
	}
	return _c
...
func (_c *ResourceCreate) check() error {
	if _, ok := _c.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`ent: missing required field "Resource.user_id"`)}
	}
