...
func (_q *UserQuery) QueryAccessTokens() *TokenQuery {
...
func (_q *UserQuery) WithAccessTokens(opts ...func(*TokenQuery)) *UserQuery {
	query := (&TokenClient{config: _q.config}).Query()
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withAccessTokens; query != nil {
		if err := _q.loadAccessTokens(ctx, query, nodes,
			func(n *User) { n.Edges.AccessTokens = []*Token{} },
			func(n *User, e *Token) { n.Edges.AccessTokens = append(n.Edges.AccessTokens, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadAccessTokens(ctx context.Context, query *TokenQuery, nodes []*User, init func(*User), assign func(*User, *Token)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(token.FieldUID)
	}
